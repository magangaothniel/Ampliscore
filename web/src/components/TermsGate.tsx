    ...
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-[100] px-4">
      <div className="bg-white rounded-2xl p-8 w-full max-w-md shadow-xl">
        <div className="text-center mb-6">
          ...
          <h2 className="text-xl font-semibold text-ink-900 mb-2">Before you get started</h2>
          <p className="text-sm text-ink-600">Please review and accept our Terms of Service and Privacy Policy to continue using Ampliscore.</p>
        </div>

        <div className="bg-purple-50 rounded-xl p-4 mb-6 text-xs text-ink-600 space-y-2">
