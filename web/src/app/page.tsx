...
function Logo() {
  return (
    <div className="flex items-center gap-3">
      ...
      <defs>
        <linearGradient id="capG_app" gradientUnits="userSpaceOnUse" x1="0" y1="64" x2="64" y2="0">
      ...
      <g transform="translate(32,34) scale(0.78) translate(-32,-29)">
        ...
        <path d="M59 23.5 L59 43" stroke="url(#capG_app)" strokeWidth="5.5" strokeLinecap="round" />
