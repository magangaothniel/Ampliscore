  ...
  return (
    <main className="min-h-screen bg-[#F5F3FF] flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <h1 className="text-3xl font-medium text-ink-900 mb-3">Welcome to Pro!</h1>
        <p className="text-ink-600 mb-8">You now have access to all Pro features. Go track those grades and crush your GPA.</p>
