    ...
    <main className="min-h-screen bg-[#F5F3FF] py-12 px-6">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white rounded-2xl border border-purple-100 p-8 md:p-12">
          ...
          <div className="space-y-6 text-sm text-ink-600 leading-relaxed">
            ...
            <section>
              <h2 className="text-lg font-semibold text-ink-900 mb-2">3. Data Sharing</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold text-ink-900 mb-2">4. Data Security</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold text-ink-900 mb-2">5. Children's Privacy (COPPA)</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold text-ink-900 mb-2">6. Your Rights (GDPR & CCPA)</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold text-ink-900 mb-2">7. Cookies</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold text-ink-900 mb-2">9. Changes to This Policy</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold text-ink-900 mb-2">10. Contact</h2>
