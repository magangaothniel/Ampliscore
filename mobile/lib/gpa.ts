/**
 * GPA maths, in one place.
 *
 * The 4.0 scale was previously duplicated in four places (DashboardScreen,
 * GPAPlannerScreen, achievements.ts, and web's utils). Any of them drifting
 ...
 *
 * Keep identical to web/src/lib/gpa.ts.
 */
